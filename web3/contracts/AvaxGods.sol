...
contract AVAXGods is ERC1155, Ownable, ERC1155Supply {
  ...
  function isPlayer(address addr) public view returns (bool) {//function isplayer which accepts parameter of type address we call it from outside and return boolean
